...
:: Configuración
set "disco=D:\Backup_Juli" :: Cambia a tu letra de disco
set "reporte=%USERPROFILE%\Desktop\Duplicados_Juli.csv"  :: Reporte en el escritorio


echo. > "%reporte%"  :: Crear archivo vacío (o sobrescribir si existe)

:: --- PASO 1: Listar TODOS los archivos con sus tamaños ---
echo Buscando archivos en %disco% & echo.
set "temp_lista=%temp%\lista_archivosJ.txt"
