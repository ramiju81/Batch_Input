...
:: Configuración
set "disco=F:\NUBE" :: Cambia a tu letra de disco
set "reporte=%USERPROFILE%\Desktop\Duplicados_Nube.csv"  :: Reporte en el escritorio
...
set "temp_lista=%temp%\lista_archivosN.txt"
