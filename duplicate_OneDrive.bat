...
:: Configuración
set "disco=F:\NUBE\OneDrive" :: Cambia a tu letra de disco
set "reporte=%USERPROFILE%\Desktop\Duplicados_OneDrive.csv"  :: Reporte en el escritorio
...
set "temp_lista=%temp%\lista_archivosO.txt"
