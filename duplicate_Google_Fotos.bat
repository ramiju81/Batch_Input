...
:: Configuración
set "disco=F:\NUBE\Google_Fotos" :: Cambia a tu letra de disco
set "reporte=%USERPROFILE%\Desktop\Duplicados_Google_Fotos.csv"  :: Reporte en el escritorio
...
set "temp_lista=%temp%\lista_archivosF.txt"
