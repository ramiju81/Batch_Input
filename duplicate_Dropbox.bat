...
:: Configuración
set "disco=F:\NUBE\Dropbox" :: Cambia a tu letra de disco
set "reporte=%USERPROFILE%\Desktop\Duplicados_Dropbox.csv"  :: Reporte en el escritorio
...
set "temp_lista=%temp%\lista_archivosD.txt"
