...
:: Configuración
set "disco=F:\NUBE\Google_Drive" :: Cambia a tu letra de disco
set "reporte=%USERPROFILE%\Desktop\Duplicados_GoogleDrive.csv"  :: Reporte en el escritorio
...
set "temp_lista=%temp%\lista_archivosG.txt"
